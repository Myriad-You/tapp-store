...
var TARGET_ENV = /^(?:MYRIAD_TAG|PROXY_TAG|UPDATER_TAG|BACKEND_IMAGE|FRONTEND_IMAGE|PROXY_IMAGE|UPDATER_IMAGE|UPDATER_IMAGE_REF|DOCKER_GUARD_IMAGE|MYRIAD_VERSION)$/;
...
function upgradeGenerated(generated,legacy) {
  ...
  Object.keys(escaped.services).forEach(function(name){
    ...
    if(values.DOCKER_GUARD_EXPECTED_IMAGE&&env.DOCKER_GUARD_IMAGE)escaped.services[name].environment.DOCKER_GUARD_EXPECTED_IMAGE='${DOCKER_GUARD_IMAGE}';
  });
