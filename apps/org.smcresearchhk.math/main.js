  ...
  var i18n = {
    'zh-CN': {
      ...
      helpBody:
        ...
        '</ul>' +
        '<h3>求值</h3><p>在「求值」框输入如 <code>sin(pi/2)</code> 或带 <code>x=</code> 的赋值（先设变量再算），查看数值结果。</p>'
    },
    'en-US': {
      ...
      helpBody:
        ...
        '</ul>' +
        '<h3>Evaluate</h3><p>Type e.g. <code>sin(pi/2)</code> in the evaluate box for a numeric result.</p>'
    },
    'ja-JP': {
      title: '関数グラフ計算機',
      help: 'ヘルプ',
