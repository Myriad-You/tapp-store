...
2. 选择上传本地打包得到的 .tapp 文件；若已安装 1.2.0 或更早版本，请用 1.3.0 包执行更新或重新安装，以应用 Myriad 0.3.35 的声明层格式。确认私有存储、通知、打开声明链接和 `network:fetch` 权限均已授予。
...
10. 点击“网页高清 PNG”确认宿主打开当前城市的 MetroMan 线路图页面；点击“更新数据”，顶栏应依次显示连接中和已连接。若显示权限未授予，请到 Tapp 权限页重新批准 `network:fetch`；若显示 API 未注册，请确认已更新到 1.3.0。
...
本分支从提交 d133f6fd59c2e46c9c3cc08725d6dc7933578b4c 创建；当前包版本为 1.3.0。建议使用中文 Conventional Commit，并启用 GPG 签名：
